...
namespace PCLStorage
{
    ...
    public interface IFileSystem
    {
        ...
        /// </summary>
        /// <param name="path">The path to a file, as returned from the <see cref="IStorageItem.Path"/> property.</param>
        ...
        /// </summary>
        /// <param name="path">The path to a folder, as returned from the <see cref="IStorageItem.Path"/> property.</param>
        /// <param name="cancellationToken">The cancellation token.</param>
